...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_effects_tune.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects_tune.xml \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_lge.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_lge.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes_lge.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_lge.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mirrorlink_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mirrorlink_audio_policy_configuration.xml \
...
PRODUCT_PACKAGES += \
    ...
    init.sdm845.crash.sh \
    init.time_in_state.sh \
    modem_debug_info.sh \
    ntcode_etc_symlinks.sh \
    pstore_backup.sh \
    ramoops_backup.sh \
    rmplb.sh \
    runtime_boot_cache_res.sh \
    runtime_boot_res.sh \
    sap_etc_symlinks.sh \
    set_emmc_size.sh \
    superset_op_delete.sh \
    wifi_runtime_conf.sh \
    init.judyp.rc \
    init.judyp_core.rc \
    init.judyp_product.rc \
    init.lge.bt.rc \
...
# WiFi
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/wifi/PerProviderSubscription.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/PerProviderSubscription.conf \
    $(LOCAL_PATH)/configs/wifi/WCNSS_qcom_cfg.ini:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/WCNSS_qcom_cfg.ini \
    $(LOCAL_PATH)/configs/wifi/bdwlan.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_ch0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_ch0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_ch1.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_ch1.bin \
    ...
    $(LOCAL_PATH)/configs/wifi/wifi_runtime_prop.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wifi_runtime_prop.conf \
    $(LOCAL_PATH)/configs/wifi/wlan_logger.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wlan_logger.conf \
